...
***REMOVED***(function($) {
  ...
  ***REMOVED***;
      ...
      ***REMOVED***
          ...
          ***REMOVED*** else if (currentRow === 1 && currentColumn === 1) {
          ...
          ***REMOVED***
        ***REMOVED*** else if (KEY.RIGHT === keyCode) {
              if (currentRow === totalRow && lastRowColumnLength === currentColumn) {
                currentColumn = 1;
                currentRow = 1;
          ***REMOVED*** else if (currentColumn < totalColumn) {
                currentColumn = currentColumn + 1;
          ***REMOVED*** else {
                currentColumn = 1;
                currentRow = currentRow + 1;
          ***REMOVED***
        ***REMOVED*** else if (KEY.UP === keyCode) {
              if (currentRow === 1 && lastRowColumnLength < currentColumn) {
                currentRow = totalRow - 1;
          ***REMOVED*** else {
                currentRow = currentRow - 1;
          ***REMOVED***
        ***REMOVED*** else if (KEY.DOWN === keyCode) {
              currentRow = currentRow + 1;
        ***REMOVED***

            if (currentRow === totalRow && currentColumn > lastRowColumnLength) {
              currentRow = 1;
        ***REMOVED*** else if (currentRow > totalRow) {
              currentRow = 1;
        ***REMOVED*** else if (currentRow < 1) {
              currentRow = totalRow;
        ***REMOVED***
      ...
      ***REMOVED***
        ...
        ***REMOVED*** else if (keyCode === ENTER_KEY) {
              enterKeyHandler();
        ***REMOVED***
            return false;
      ***REMOVED***
