...
function _interopDefault (ex) { return (ex && (typeof ex === 'object') && 'default' in ex) ? ex['default'] : ex; ***REMOVED***
...
var MetisMenu = /*#__PURE__*/function () {
  ...
  function MetisMenu(element, config) {
    ...
    this.config = _extends({***REMOVED***, Default, {***REMOVED***, config);
  ...
  ***REMOVED***;
  ...
  MetisMenu.jQueryInterface = function jQueryInterface(config) {
    ...
    return this.each(function () {
      ...
      var conf = _extends({***REMOVED***, Default, {***REMOVED***, $this.data(), {***REMOVED***, typeof config === 'object' && config ? config : {***REMOVED***);
