...
***REMOVED***;
  ...
  ***REMOVED*** // If any pointer event is called on the scrollbar
...
***REMOVED***;
  ...
  ***REMOVED*** else {
        eventOffset = e.pageX;
  ***REMOVED*** // Calculate how far the user's mouse is from the top/left of the scrollbar (minus the dragOffset).
...
***REMOVED***;
    ...
    this.options = Object.assign({***REMOVED***, SimpleBar.defaultOptions, options);
    this.classNames = Object.assign({***REMOVED***, SimpleBar.defaultOptions.classNames, this.options.classNames);
    this.isRtl;
    this.axis = {
      x: {
...
***REMOVED***;
  ...
  ***REMOVED***);
      this.globalObserver.observe(document, {
        ...
        subtree: true
  ***REMOVED***);
***REMOVED*** // Taken from jQuery `ready` function
...
***REMOVED***
  ***REMOVED*** // Helper function to retrieve options from element attributes
  ;
...
***REMOVED*** // Even if forceVisible is enabled, scrollbar itself should be hidden
