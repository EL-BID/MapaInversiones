                        ...
                        response($.map(data, function (item) {
                            ...
                            switch (item.Categoria) {
                                case 'DEPARTAMENTO':
                                    ...
                                    $("#divResultados").append("<div class=\"search-item-t\"> <a class=\"enlace_resultados\" onclick=\"ocultarDiv('" + item.Nombre + "','" + item.Id + "');\"> <img src=\"" + iconocategoria + "\" /> " + item.Nombre + "</a><div class=\"clearfix\"><a class=\"pull-left orangeLink\" role=\"button\">Ver Perfil <span class=\"glyphicon glyphicon-chevron-right\"</span></a><a class=\"reset-filters\" role=\"button\" data-bind=\"tap: unselectAll\"> Ver Mapa <span class=\"glyphicon glyphicon-chevron-right\"></span></a></div></div>");
                                    break;
                                case 'MUNICIPIO':
                                    iconocategoria = '../content/img/icons/icon-municipios-color.svg';
                                    $("#divResultados").append("<div class=\"search-item-t\"> <a class=\"enlace_resultados\" onclick=\"ocultarDiv('" + item.Nombre + "','" + item.Id + "');\"> <img src=\"" + iconocategoria + "\" /> " + item.Nombre + "</a><div class=\"clearfix\"><a class=\"pull-left orangeLink\" role=\"button\">Ver Perfil <span class=\"glyphicon glyphicon-chevron-right\"</span></a><a class=\"pull-right orangeLink general-search\" role=\"button\" data-bind=\"tap: general-search\"> Ver Mapa <span class=\"glyphicon glyphicon-chevron-right\"></span></a></div></div>");
                                    break;
                                default:
                                    iconocategoria = '../content/img/icons/icon-proyectos-color.svg';
                                    $("#divResultados").append("<div class=\"search-item-t\"> <a class=\"enlace_resultados\" onclick=\"ocultarDiv('" + item.Nombre + "','" + item.Id + "');\"> <img src=\"" + iconocategoria + "\" /> " + item.Nombre + "</a><div class=\"clearfix\"><a class=\"pull-left orangeLink\" role=\"button\">Ver Perfil <span class=\"glyphicon glyphicon-chevron-right\"</span></a></div></div>");
                        ***REMOVED***
	...
	var AppState = new Class( Observable, {
		...
		initialize: function(){
			...
			***REMOVED***)
			...
			router.on(/\/(proyectos|locationProfile|recursos|produccion|fiscalizacion|(\?.+)?)/, function(){
...
define('app/map/Map',['lib/mvc/Observable',
	...
	function Map(){
		var map, // Bing Map
			...
			***REMOVED***,
			// Center of Colombia
			center = new Microsoft.Maps.Location(-23.068633311872418, -58.54084472656249),
		...
		***REMOVED*** )
		...
		function themesModuleLoaded(){
			...
			map = new Microsoft.Maps.Map(
				...
				{
					credentials: 'AiesXotdtlT-c30Kgkb6s9iXHxnYJ0prDhgxkNzxflae0ahFDlHz98MEtCw7hoRq',
					zoom: defaultZoom,
...
require([
	...
	***REMOVED***)
	...
	Map.on('polygons-initialized', function () {
	...
	***REMOVED***)
		...
		if(location.pathname.indexOf('LocationProfile') !== -1)
		{
			params = location.hash.match(/\?.+/)
			this.lastRequestedUrl = location.hash
			//history.pushState('', '', location.pathname + '/proyectos/');
	...
	***REMOVED***
	...
	$("#divResultados").on('click', 'a', function (e) {
	    e.preventDefault()
	...
	***REMOVED***);
	...
	var SearchViewModel = {
	    addToFilters: function (dataType, dataValue) {
			...
			FiltersManager.selectFilterWith(dataType, dataValue, 'noNotify')
			FiltersManager.fireEvent('territory-activated',dataType, options)
			//FiltersManager.filter.fireEvent('activated-by-user', dataType, FiltersManager.filter.getActive())
			AppState.setFiltersString( FiltersManager.getQueryFilters() )
			AppState.updateURL()
	***REMOVED***
	***REMOVED***;
