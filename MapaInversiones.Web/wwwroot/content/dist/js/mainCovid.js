...
define('app/controller/AppState',[
	...
	***REMOVED***)
	...
	var AppState = new Class( Observable, {
		...
		center: [-24.266015239534894, -58.59577636718749],
		defaultCenter: [-24.266015239534894, -58.59577636718749],
						...
						if(location.pathname.indexOf('LocationProfile') !== -1)
                        {
							...
							if (params) {
								...
								***REMOVED***						
								...
								if( value && SetLocationProfileMap ){
		...
		***REMOVED***,
		...
		updateQueryByURL: function(){
			...
			if (!query){
			    ...
			    if (!this.center)
                {
			        this.center = [-24.266015239534894, -58.59577636718749]
			***REMOVED***
			...
			if( !this.isListMode || !this.state ){
				...
				***REMOVED***
				...
				if (query.indexOf("center") != -1 && (query.indexOf("bottomRight") == -1 || query.indexOf("topLeft") == -1)) {
				    query += '&topLeft=-20.81673411372121,-66.3960693359375'
				    query += '&bottomRight=-27.62418590594018,-50.7954833984375'
				***REMOVED***
...
require([
	...
	***REMOVED***);
	...
	$("#divResultados").on('click', '.enlace_subsidios', function (e) {
        var dataValue = $(this).attr('data-parameter');
        var url = "/covid/perfilsubsidio/?subsidio=" + dataValue;
        if (dataValue == "234211") {
            url = "/covid/perfilFarmacias";
    ***REMOVED***
