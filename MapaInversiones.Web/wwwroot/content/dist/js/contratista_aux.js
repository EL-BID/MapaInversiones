...
require([
    ...
    function (
        ...
        function donut_percent(div_contenedor, data_contenido, tipo_dato, etiqueta) {
            ...
            var pie = d3.pie()
                .value(function (d) { return d.rawValue; })
                .sort(null);
            ...
            var path = g.selectAll('path')
                ...
                .append('path')
                .attr('d', arc)
                .style("opacity", function (d, i) { return i == 1 ? 0.5 : 1; })
        ...
        function getAnnio() {
            //debugger;
            var params_usu = { "ruc": ruc_contratista };
            $.ajax({
                type: 'GET',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function timeLine(div, data) {
            ...
            // set the ranges
            var x = d3.scaleTime().range([0, width - 5]).domain(data.map(function (d) { return d.date }));
            ...
            var chart1 = svg.selectAll('.axis .axis--x .tick')
                ...
                .enter()
                .append('circle')
                .attr('r', function (d) { return radio + 1.5 }) // visit duration
                .attr('cy', 20) // centers circle
                .attr('cx', function (d) { return x(d.date); }) // not final. Should be aligned to x axis time
            ...
            var textUp = svg.selectAll('.axis .axis--x .tick')
                        ...
                        .attr('x', function (d) { return x(d.date); })
                        .attr("text-anchor", "middle")
                        .text(function (d) { return d.textUp; });
            ...
            var textDown = svg.selectAll('.axis .axis--x .tick')
                        ...
                        .attr('x', function (d) { return x(d.date); })
                        .attr("text-anchor", "middle")
                        .text(function (d) { return d.textDown; });
...
define("contratista_aux", function () { });