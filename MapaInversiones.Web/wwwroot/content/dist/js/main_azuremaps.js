...
(function () {
	...
	define('app/controller/AppState', [
		...
		// --- STATE por defecto
		AppState.zoom = 12;
		AppState.center = [3.393735807054995, -76.63693135216425]; // [lat,lon]
		AppState.defaultCenter = AppState.center.slice();
		AppState.corners = [[3.5787869239924532, -76.88000386192988], [3.2086492408465404, -76.39385884239863]];
		...
		function getCamera(mapWrapper) {
			...
			return cam || { center: [-74.1, 4.65], zoom: 5 };
		}
