                    ...
                    if (result.status == true) {
                        if (result.CantidadTotalRegistros > 0) {
                            ...
                            for (var i = 0; i < info.length; i++) {
                                ...
                                if (info[i].COVID19 === 2 || info[i].COVID19 === 1) { filaconfirma += '                        <span class="badge"><img src="../../../content/img/covid/ic_mini.png" alt="iconoCOVID"> Covid-19</span>'; }
...
define("contratosrp_aux", function () { });