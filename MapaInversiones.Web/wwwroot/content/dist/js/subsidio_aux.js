require([
    ...
    function (
        ...
        inicializaDatos();
        var data = [
            { "labelGroup": "ASUNCION", "label": "ASUNCION", "value": 15 },
            { "labelGroup": "CONCEPCION", "label": "CONCEPCION", "value": 10 },
            { "labelGroup": "SAN PEDRO", "label": "SAN PEDRO", "value": 5 },
        ];
        ...
        function loadGraphSubsidiosPerFaseDpto(div_contenedor, data_contenido, titulo, etiqueta) {
            if (data_contenido != undefined && data_contenido != null) {
                ...
                var visualization = d3plus.viz()
                    ...
                    .type("bar")
                    .id("label")
                    .x({ "stacked": false, "value": "labelGroup" })
                    .y("rawValue")
                    .format({
                        "text": function (text, params) {
        ...
        function GetSubsidiosPerDpto() {
            ...
            var params_usu = { "IdSubsidio": idsubsidio };
            $.ajax({
                type: 'GET',
