    ...
    function loadFichaUnica(resultados, div_contenedor, div_padre, func_fin) {
        if ($("#" + div_padre).length > 0) {
            ...
            if (minus_proy.length > 110) {
             ...
             var aux_div_col = d3.select("#" + div_contenedor)
               ...
               .attr("class", "labelCategory").text(resultados.NombreSector)
                ...
                //.attr("href", "")
                .attr("href", "../Proyecto/PerfilProyectoPot/" + resultados.IdProyecto)
                ...
                //var aux_a13 = aux_div_col_int.append("a").attr("href", "../Proyecto/PerfilProyectoPot/" + resultados.IdProyecto)
                ...
                var aux_a23 = aux_div_col_int2.append("a").attr("href", "../Proyecto/PerfilProyectoPot/" + resultados.IdProyecto)
            ...
            var aux_div_col_int3 = aux_div_proy_links.append("div").attr("class", "col-xs-6 col-md-6")
                var aux_a3 = aux_div_col_int3.append("a").attr("href", "../Proyecto/PerfilProyectoPot/" + resultados.IdProyecto)
