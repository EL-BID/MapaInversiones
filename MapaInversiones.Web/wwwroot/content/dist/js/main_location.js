...
define('app/controller/AppState', [
    ...
    var AppState = new Class(Observable, {
        // Request params
        zoom: 8, // 1,..,n
        corners: [[14.75110258191421, -86.7590020491403], [9.706071967288466, -59.46813471326766]], // [[4.667292,-74.059508], [4.667292,-74.059508]]
    ...
    function (
        ...
        function Map() {
            ...
            self.zoomToColombia = function () {
                ...
                if (map) {
                    map.setView({ center: new Microsoft.Maps.Location(14.75110258191421, -86.7590020491403), zoom: defaultZoom });
