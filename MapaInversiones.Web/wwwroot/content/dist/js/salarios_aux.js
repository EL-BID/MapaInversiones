    ...
    function (
        ...
        function obtMatrizDataBonifica(data) {
            ...
            $.each(data, function (key, value) {
                var obj_aux = { name: value.label, total: value.rawValue, percent: value.porcentaje, total_asoc: value.rawValue_asoc, color: colors[i] };
        ...
        function obtMatrizData(data) {
            var dataset_33 = [
                ...
                { name: 'Endeudamiento en gestión', total: 370, percent: 23.12, color: "#FB9A99" }
            ];
            ...
            $.each(data, function (key, value) {
                var obj_aux = { name: value.NombreEntidad, total: value.Valor, percent: value.porcentaje, color: colors[i] };
                obj_nodos.push(obj_aux);
                i += 1;
        ...
        function barra_vertical_old(div_contenedor, data_contenido, titulo, color) {
            ...
            if (myData.length > 0) {
                maximo = d3.max(myData, function (d) { return d.rawValue; });
                minimo = d3.min(myData, function (d) { return d.rawValue; });
            }
            ...
            var y = d3.scale.linear()
                .domain([0, d3.max(myData, function (d) { return d.rawValue; })])
                .range([0, height])
            ...
            y.domain([0, d3.max(myData, function (d) { return d.rawValue; })]);
            ...
            g.selectAll(".bar")
                ...
                .attr("y", function (d) { return y(d.rawValue); })
                .attr("width", x.bandwidth())
                .attr("height", function (d) { return height - y(d.rawValue); })
        ...
        function barra_Horizontal_new(div_contenedor, data_contenido) {
            ...
            var margin = { top: 20, right: 20, bottom: 30, left: 290 },
            ...
            y.domain(data.map(function (d) { return d.NombreEntidad; }));
            ...
            svg.selectAll(".bar")
                ...
                .attr("y", function (d) { return y(d.NombreEntidad); })
