...
var data_fisico = [{ "year": anyo_actual, "name": "Avance fisico", "value": avance_fisico, "group": "fisico" }];
var data_financiero = [{ "year": anyo_actual, "name": "Avance financiero", "value": avance_financiero, "group": "financiero" }];
                    ...
                    for (var i = 0; i < items_result.length; i++) {
                       ...
                       .attr("class", "badge pull-right")
                        ...
                        if ($(nom_div.length > 0)) {
                            ...
                            var data_financiero = [{ "year": anyo_actual, "name": items_result[i].Nombre, "value": porcentaje }];
               ...
               .title(
                    {
                        "value": titulo,
                        //"padding": 2,
                        "font": { "size": 14, "family": "inherit", "align": "left" }
                    }
                    )
                .height({ "small": 70, "value": 80 })
                .axes({
                    "background": { "color": "rgba(255,255,255,0)", "ticks": true, "stroke": { "width": 2, "color": color } },
                    "font": { "family": "inherit" },
                    "label": true
                })
                .x(
                    {
                        "stacked": false,
                        "value": "value",
                        "axis": { "padding": "10px", "color": "#1a237e", "border-color": color },
                        "ticks": { "color": "#CCCCCC", "labels": [0, 0.2, 0.4, 0.6, 0.8, 1] },
                        "stacked": false,
                        "lines": { "color": "#E14C21" },
                        "scale": "share",
                        "padding": 1,
                    ...
                    .y(
                    {
                        ...
                        "lines": { "color": "#E14C21", "width": 60 },
                        "axis": { "padding": "1px", "color": "rgba(255,255,255,0)", "label": false },
                        "grid": false,
                        "label": {
                            "value": false,
                            //"padding": 10,
                            "font": { "family": "inherit", "weight": "bold", "size": 14, "color": "rgba(255,255,255,0)" }
                        }

                    })
                //.time({ "value": "year", "fixed":true})
                .resize(true)
                .draw()
	    }
     ...
     function make_viz(div_contenedor, data_contenido, titulo,color,etiqueta) {
            ...
            .x(
                {
                    "stacked": false,
                    "value": "value",
                    "axis": { "padding": "10px", "color": "#005951", "border-color": "#bc102a" },
                    "ticks": { "color": "#CCCCCC", "labels": [0, 0.2, 0.4, 0.6, 0.8, 1] },
                    "stacked": false,
                    "lines": { "color": "#E14C21" },
                    "scale": "share",
                ...
                .y(
                {
                    ...
                    "value": "year",
                    "ticks": { "color": "rgba(255,255,255,0)", "labels": false },
                    "lines": { "color": "#E14C21", "width": 100 },
                    "axis": { "padding": "10px", "color": "#005951", "label": false },
                    "grid": false,
                    "label": {
                        "value": false,
                        "padding": 10,
	    ...
	    function GetComentariosConsolidado(id) {
            ...
            .done(function (result) {
                ...
                //    }
                  ...
                  //.y({ "scale": "discrete","value":"EtiquetaOpcion" })
                //.draw()
                //---------------------------------------------
	    ...
	    function AddnuevoUsuario() {
         ...
         function getAnnio() {
             ...
             var params_usu = { "idproyecto" : projectPerfil[0].id_project};
             $.ajax({
                 type: 'GET',
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
         ...
         function getContratos(annio, ruc, pagina, registros, idproyecto, nombreContratista) {
             ...
             if (ruc === "") { ruc = null }
             if (nombreContratista === "") { nombreContratista = null }
