  ...
  ***REMOVED***
  ...
  function applyStyles(_ref) {
    ...
    Object.keys(state.elements).forEach(function (name) {
      var style = state.styles[name] || {***REMOVED***;
      var attributes = state.attributes[name] || {***REMOVED***;
    ...
    return function () {
      Object.keys(state.elements).forEach(function (name) {
        ...
        var style = styleProperties.reduce(function (style, property) {
          style[property] = '';
          return style;
      ***REMOVED*** {***REMOVED***); // arrow is optional + virtual elements
...
***REMOVED***;
  ***REMOVED***
  ...
  function mergePaddingObject(paddingObject) {
    return Object.assign({***REMOVED***, getFreshSideObject(), paddingObject);
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  var toPaddingObject = function toPaddingObject(padding, state) {
    padding = typeof padding === 'function' ? padding(Object.assign({***REMOVED***, state.rects, {
...
***REMOVED***
    ...
    var axisProp = axis;
    state.modifiersData[name] = (_state$modifiersData$ = {***REMOVED***, _state$modifiersData$[axisProp] = offset, _state$modifiersData$.centerOffset = offset - center, _state$modifiersData$);
  ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** adaptive && unsetSides);
    ...
    if (gpuAcceleration) {
      ...
      return Object.assign({***REMOVED***, commonStyles, (_Object$assign = {***REMOVED***, _Object$assign[sideY] = hasY ? '0' : '', _Object$assign[sideX] = hasX ? '0' : '', _Object$assign.transform = (win.devicePixelRatio || 1) < 2 ? "translate(" + x + "px, " + y + "px)" : "translate3d(" + x + "px, " + y + "px, 0)", _Object$assign));
***REMOVED***

    return Object.assign({***REMOVED***, commonStyles, (_Object$assign2 = {***REMOVED***, _Object$assign2[sideY] = hasY ? y + "px" : '', _Object$assign2[sideX] = hasX ? x + "px" : '', _Object$assign2.transform = '', _Object$assign2));
  ***REMOVED***
...
***REMOVED***;
    ...
    if (state.modifiersData.popperOffsets != null) {
      state.styles.popper = Object.assign({***REMOVED***, state.styles.popper, mapToStyles(Object.assign({***REMOVED***, commonStyles, {
...
***REMOVED***
    ...
    if (state.modifiersData.arrow != null) {
      state.styles.arrow = Object.assign({***REMOVED***, state.styles.arrow, mapToStyles(Object.assign({***REMOVED***, commonStyles, {
...
***REMOVED***
    ...
    state.attributes.popper = Object.assign({***REMOVED***, state.attributes.popper, {
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  function rectToClientRect(rect) {
    return Object.assign({***REMOVED***, rect, {
      left: rect.x,
      top: rect.y,
...
***REMOVED***
    ...
    var popperOffsets = computeOffsets({
      ...
      placement: placement
***REMOVED***);
    var popperClientRect = rectToClientRect(Object.assign({***REMOVED***, popperRect, popperOffsets));
...
***REMOVED***);
  ...
  ***REMOVED***;
  ...
  function distanceAndSkiddingToXY(placement, rects, offset) {
    ...
    var _ref = typeof offset === 'function' ? offset(Object.assign({***REMOVED***, rects, {
      placement: placement
***REMOVED***)) : offset,
        skidding = _ref[0],
        distance = _ref[1];
...
***REMOVED***);
    ...
    var referenceRect = state.rects.reference;
    var popperRect = state.rects.popper;
    var tetherOffsetValue = typeof tetherOffset === 'function' ? tetherOffset(Object.assign({***REMOVED***, state.rects, {
      placement: state.placement
...
***REMOVED***;
  ...
  ***REMOVED*** else if (documentElement) {
  ...
  ***REMOVED***
  ...
  function mergeByName(modifiers) {
    var merged = modifiers.reduce(function (merged, current) {
      ...
      merged[current.name] = existing ? Object.assign({***REMOVED***, existing, current, {
        options: Object.assign({***REMOVED***, existing.options, current.options),
        data: Object.assign({***REMOVED***, existing.data, current.data)
  ***REMOVED***) : current;
      return merged;
  ***REMOVED*** {***REMOVED***); // IE11 does not support Object.values
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      var state = {
        placement: 'bottom',
        orderedModifiers: [],
        options: Object.assign({***REMOVED***, DEFAULT_OPTIONS, defaultOptions),
        modifiersData: {***REMOVED***,
        elements: {
          reference: reference,
          popper: popper
      ***REMOVED***
  ...
  ***REMOVED***;
      ...
      var instance = {
        ...
        setOptions: function setOptions(options) {
          ...
          state.options = Object.assign({***REMOVED***, defaultOptions, state.options, options);
          state.scrollParents = {
      ...
      ***REMOVED***; // Modifiers have the ability to reset the current update cycle. The
          ...
          state.orderedModifiers.forEach(function (modifier) {
            return state.modifiersData[modifier.name] = Object.assign({***REMOVED***, modifier.data);
      ***REMOVED***);
        ...
        ***REMOVED***
            ...
            var _state$orderedModifie = state.orderedModifiers[index],
                ...
                _options = _state$orderedModifie2 === void 0 ? {***REMOVED*** : _state$orderedModifie2,
      ...
      function runModifierEffects() {
        state.orderedModifiers.forEach(function (_ref3) {
          var name = _ref3.name,
              ...
              options = _ref3$options === void 0 ? {***REMOVED*** : _ref3$options,
              effect = _ref3.effect;
        ...
        ***REMOVED***);
            ...
            var noopFn = function noopFn() {***REMOVED***;
...
***REMOVED***
  ...
  ***REMOVED*** else if (isElement$1(this._config.reference)) {
