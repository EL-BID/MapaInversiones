...
(function ($) {
    ...
    $.fn.czmChatSupport = function (options) {
        ...
        var defaults = {
          ...
          ***REMOVED***
            sound: true,
            changeBrowserTitle: "MapaInversiones",
            cookie: false,
            timezone: false,
            onLoad: function () {***REMOVED***,
            onClick: function () {***REMOVED***,
            onPopupOpen: function () {***REMOVED***,
            onPopupClose: function () {***REMOVED***
    ***REMOVED***;
        ...
        var settings = $.extend(true, {***REMOVED***, defaults, options);
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED*** else if (settings.button.position == 'left') {
        ...
        ***REMOVED***
            ...
            if ((settings.button.link.desktop !== false) || (settings.button.link.mobile !== false)) {
                ...
                ***REMOVED*** else if (moment(mtimezone.format('HH:mm:ss'), 'HH:mm:ss').isBetween(moment(settings.button.onlineDay[mtimezone.format('dddd').toLowerCase()].split('-')[0] + ':00', 'HH:mm:ss'), moment(settings.button.onlineDay[mtimezone.format('dddd').toLowerCase()].split('-')[1] + ':59', 'HH:mm:ss')) == false) {

                        buttonOnline = false;
                ***REMOVED***
            ***REMOVED***

        ***REMOVED*** else if (settings.popup.persons.length == 0) {
        ...
        ***REMOVED*** else if ((settings.button.style == 2) || (settings.button.style == 4) || (settings.button.style == 6) || (settings.button.style == 7)) {
        ...
        ***REMOVED***
            ...
            ***REMOVED***
                ...
                ***REMOVED***
                    ...
                    ***REMOVED*** else if (moment(mtimezone.format('HH:mm:ss'), 'HH:mm:ss').isBetween(moment(settings.popup.persons[p].onlineDay[mtimezone.format('dddd').toLowerCase()].split('-')[0] + ':00', 'HH:mm:ss'), moment(settings.popup.persons[p].onlineDay[mtimezone.format('dddd').toLowerCase()].split('-')[1] + ':59', 'HH:mm:ss')) == false) {
        ...
        ***REMOVED***
            ...
            ***REMOVED*** else if (document.querySelector('link[rel="icon"]') !== null) {
