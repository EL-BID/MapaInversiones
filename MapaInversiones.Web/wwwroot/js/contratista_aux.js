        ...
        new d3plus.BarChart()
            ...
            .config({
                ...
                tooltipConfig: {
                    ...
                    tbody: [
                        [function (d) { return "$ " + (d["rawValue"]).formatMoney(2, ',', '.').toString() + " " }]
                    ]
                },
                yConfig: {
                    maxSize: "100px",
            ...
            if (result.status == true) {
                if (result.cantidadTotalRegistros > 0) {
                    ...
                    for (var i = 0; i < info.length; i++) {
                        if (proceso != info[i].codigoProceso.toString() || origen != info[i].origenInformacion.toString()) {
                            ...
                            if (i > 0) //Cambio de proceso
                            {
                                data += inicioLuis + inicio + fila + finLuis + fin;
                                    ...
                                    data += '<div class="row text-center">'
                                        + '<div class="col-xs-12 col-md-12"><a href="' + urlProceso + '" target="_blank" class="btn btn-outlined"><i class="material-icons md-22">launch</i> <span class="txt_small">Conoce más de este proceso</span></a></div>'
                                        + '</div></div>' + finLuis;
                            ...
                            inicio += '     </div>'
                                ...
                                + '     <span class="h4">Contrato(s) u órden(es) de compra:</span>'//Contratos de ' + info[i].origenInformacion.toString().toUpperCase().split(' ')[info[i].origenInformacion.toString().toUpperCase().split(' ').length-1] + ' asociados a este proceso
                    ...
                    if (urlProceso != '') {
                        ...
                        data += '<div class="row text-center">'
                            + '<div class="col-xs-12 col-md-12"><a href="' + urlProceso + '" target="_blank" class="btn btn-outlined"><i class="material-icons md-22">launch</i> <span class="txt_small">¡Conocé más de este proceso!</span></a></div>'
                            + '</div></div>' + finLuis;
