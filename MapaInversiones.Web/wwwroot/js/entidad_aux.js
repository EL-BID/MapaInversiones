    ...
    if ($("#" + divContenedor).length > 0) {
        ...
        if (objData != undefined && objData != null) {
            for (var cont = 0; cont < objData.length; cont++) {
                ...
                var aux_meta = { id: "meta", x: objData[cont].anio, y: porc_meta ***REMOVED***;
                data.push(aux_meta);
                var aux_avance = { id: "avance", x: objData[cont].anio, y: porc_avance ***REMOVED***;
                    ...
                    .config({
                      ...
                      ***REMOVED***
                        tooltipConfig: {
                          ...
                          ***REMOVED***
                            tbody: [
                                ["Porcentaje", function (d) { return d["y"] + "%" ***REMOVED***]
                            ]
                      ***REMOVED***
                        yConfig: {
                            title: "",
...
function GetConsolidadoProgramas(anio) {
  ...
  ***REMOVED***);
  ...
  //      var nuevoNodo = { "id": data.nodos[i] ***REMOVED***;
  //      nodes.push(nuevoNodo);
  //***REMOVED***
  //    for (var i = 0; i < data.enlaces.length; i++) {
  //      var nuevoLink = { "source": data.enlaces[i].emisor, "target": data.enlaces[i].receptor ***REMOVED***
