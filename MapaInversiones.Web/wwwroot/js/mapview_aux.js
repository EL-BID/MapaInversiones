...
function makeCellHtml(resultados) {
    ...
    for (var i = 0; i < resultados.length; i++) {
        ...
        str_cad += '<a href="../PerfilProyectoPot/' + resultados[i].idProyecto + '">';
        ...
        //}
        str_cad += '<div class="amount"><span class="bigNumber">' + "$ " + shared.formatoMoneda(resultados[i].approvedTotalMoney,0,1) + '</span></div>';
        str_cad += '</a>';
        str_cad += '</div>';
        str_cad += '</div>';
