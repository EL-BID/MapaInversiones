...
namespace PlataformaTransparencia.Negocios.Home
{
  public class ConsolidadosNacionalesBLL : IConsolidadosNacionalesBLL
  {
    ...
    public List<InfoRecAsignadosPlan> GetRecursosAsigByObjEstrategico(int id)
    {
      ...
      //    var myData = [
      //    { labelGroup: "Desarrollo sostenible", label: "meta", periodo: 2019, meta: 1000, porcentaje: -1 },
      //    { labelGroup: "Desarrollo sostenible", label: "meta", periodo: 2020, meta: 5000 , porcentaje: -1},
      //    { labelGroup: "Desarrollo sostenible", label: "meta", periodo: 2021, meta: 3800 ,  porcentaje: -1 },
      //    { labelGroup: "Desarrollo sostenible",label: "avance", periodo: 2019, meta: 800, porcentaje: 30 },
      //    { labelGroup: "Desarrollo sostenible", label: "avance" , periodo: 2020, meta: 3200 , porcentaje: 30 },
      //    { labelGroup: "Desarrollo sostenible", label: "avance" , periodo: 2021, meta: 3000 , porcentaje: 40 }
    ...
    public List<ModelAvanceIndicador> GetHistoricoAvanceIndicador(int indicadorId)
    {
      ...
      //objReturn.Add(new ModelAvanceIndicador { label = "2012", rawValueDouble  = 57.7, labelGroup="Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2013", rawValueDouble = 57.7, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2014", rawValueDouble = 57.6, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2015", rawValueDouble = 63.5, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2016", rawValueDouble = 67.0, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2017", rawValueDouble = 70.4, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2018", rawValueDouble = 67.8, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2019", rawValueDouble = 65.8, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2020", rawValueDouble = 55.0, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2021", rawValueDouble = 0.0, labelGroup = "Avance" });
      //objReturn.Add(new ModelAvanceIndicador { label = "2022", rawValueDouble = 0.0, labelGroup = "Avance" });
