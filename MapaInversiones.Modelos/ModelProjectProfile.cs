...
namespace PlataformaTransparencia.Modelos
{
  public class ModelProjectProfile
  {
    ...
    public List<PlanOrdenamientoTerritorialProyectos> PlanOrdenamientoTerriotrial { get; set; }

    public List<PlanDesarrolloProyectos> PlanDesarrollo { get; set; }

    //Proyecto de inversión
    public List<Item> PlanesMetaProducto { get; set; }
    public List<Item> EstadosProyectos { get; set; }
    public List<Item> Horizontes { get; set; }
  }
}
