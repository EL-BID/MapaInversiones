...
namespace PlataformaTransparencia.Modelos
{
  public class ModelLocationData : RespuestaContratoBase
  {
    ...
    public InfoParticipacionSector ParticipacionSector { get; set; }

    public List<InfoParticipacionSector> GastoSector { get; set; }

    public List<InfoConsolidadoProyectosInversion> infoConsolidadoProyectosInversions { get; set; }

    public List<InfoOds> infoOds { get; set; } = [];
    public List<Item> InfoEntidades { get; set; } = [];
    public List<Item> InfoDestacados { get; set; } = [];
    public List<Item> InfoSectores { get; set; } = [];
  }
