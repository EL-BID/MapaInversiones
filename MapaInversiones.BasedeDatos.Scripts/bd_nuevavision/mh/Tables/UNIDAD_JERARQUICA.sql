CREATE TABLE [mh].[UNIDAD_JERARQUICA] (
    ...
    CONSTRAINT [FK_UNIDAD_J_FK_ENTIDA_ESTRUCTU] FOREIGN KEY ([idEntidadPresupuestaria]) REFERENCES [mh].[ESTRUCTURA_PRESUPUESTARIA] ([idEstructuraPresupuestaria])
);
