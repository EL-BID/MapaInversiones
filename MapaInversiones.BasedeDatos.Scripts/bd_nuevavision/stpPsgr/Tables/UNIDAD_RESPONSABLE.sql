CREATE TABLE [stpPsgr].[UNIDAD_RESPONSABLE] (
    ...
    CONSTRAINT [FK_UNIDAD_R_FK_UNIDAD_UNIDAD_J] FOREIGN KEY ([idUnidadJerarquica]) REFERENCES [stpPsgr].[UNIDAD_JERARQUICA] ([idUnidadJerarquica])
);
