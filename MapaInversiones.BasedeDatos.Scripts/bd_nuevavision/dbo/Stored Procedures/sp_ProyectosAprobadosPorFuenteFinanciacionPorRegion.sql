...
-- Description:	Procedimiento almacenado que obtiene los proyectos aprobados por fuente por region.
-- =============================================
CREATE PROCEDURE [dbo].[sp_ProyectosAprobadosPorFuenteFinanciacionPorRegion]
...
BEGIN
	...
	AND EFP.IdDepartamento IN (SELECT DISTINCT IdDepartamento FROM EnteTerritorial (nolock) WHERE IdRegion = @IdRegion )		
