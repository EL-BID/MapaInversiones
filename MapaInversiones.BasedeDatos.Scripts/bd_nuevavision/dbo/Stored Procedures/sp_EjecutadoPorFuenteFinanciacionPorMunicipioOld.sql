...
-- =============================================
CREATE PROCEDURE [dbo].[sp_EjecutadoPorFuenteFinanciacionPorMunicipioOld]
...
BEGIN
    ...
    HE.ActualSiNo = 1 AND
	SEFP.IdMunicipio = @IdMunicipio AND
	PER.Periodo BETWEEN DATEPART(YEAR,SEFP.FechaInicioReporte) AND DATEPART(YEAR,SEFP.FechaFinalReporte)
