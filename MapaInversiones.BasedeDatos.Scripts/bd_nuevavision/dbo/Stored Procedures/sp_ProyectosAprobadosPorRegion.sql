...
-- =============================================
CREATE PROCEDURE [dbo].[sp_ProyectosAprobadosPorRegion]
...
BEGIN
    ...
    SELECT DISTINCT 2012 AS Periodo, --PER.Periodo Periodo, 
		...
		'N/A' AS NombreMunicipio,--ET.NombreMunicipio,
	...
	FROM VwProyectosAprobados (nolock)  aprob 
		...
		INNER JOIN dbo.HistoriaEstado(nolock) HE ON P.IdProyecto = HE.IdProyecto
	...
	AND PER.Periodo BETWEEN DATEPART(year,P.FechaInicioProyecto) AND DATEPART(year,P.FechaFinProyecto) 
