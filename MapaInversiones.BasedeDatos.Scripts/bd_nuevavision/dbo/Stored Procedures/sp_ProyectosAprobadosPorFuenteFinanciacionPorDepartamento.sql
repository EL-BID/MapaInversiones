...
-- Description:	Procedimiento almacenado que obtiene los proyectos aprobados por fuente de financiacion para un departamento.
-- =============================================
CREATE PROCEDURE [dbo].[sp_ProyectosAprobadosPorFuenteFinanciacionPorDepartamento]
...
BEGIN
	...
	AND EFP.IdMunicipio IN( SELECT TOP 1 EnteTerritorial.IdMunicipio FROM EnteTerritorial(nolock) WHERE EnteTerritorial.IdDepartamento = @IdDepartamento AND EnteTerritorial.Tipo = 'DEPARTAMENTO')			
