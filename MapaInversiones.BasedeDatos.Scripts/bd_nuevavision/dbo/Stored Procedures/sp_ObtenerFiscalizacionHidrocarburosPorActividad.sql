...
-- Description:	Obtiene la informacion para la grafica de fiscalizaciones de hidrocarburos por actividad
-- =============================================
CREATE PROCEDURE [dbo].[sp_ObtenerFiscalizacionHidrocarburosPorActividad]
...
BEGIN
	...
	WHERE TRN.IdTipoRecursoNatural = 'H'
	GROUP BY TA.Nombre 
