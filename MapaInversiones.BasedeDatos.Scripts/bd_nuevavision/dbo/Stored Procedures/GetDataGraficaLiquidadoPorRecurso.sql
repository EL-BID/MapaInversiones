...
-- =============================================
CREATE PROCEDURE [dbo].[GetDataGraficaLiquidadoPorRecurso]
...
FROM            Liquidacion(nolock) INNER JOIN
                         RecursoNatural (nolock) ON Liquidacion.IdRecursoNatural = RecursoNatural.IdRecursoNatural AND 
