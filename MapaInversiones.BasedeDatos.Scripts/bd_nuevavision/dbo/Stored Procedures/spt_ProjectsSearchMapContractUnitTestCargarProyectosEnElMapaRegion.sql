...
CREATE procedure [dbo].[spt_ProjectsSearchMapContractUnitTestCargarProyectosEnElMapaRegion]
(
	@departamentos VARCHAR(10)
)
as

--declare @departamentos VARCHAR(10)
--set @departamentos='03'
...
AND ente.IdRegion = @departamentos
