...
-- =============================================
CREATE PROCEDURE [dbo].[sp_ProyectosAprobadosPorDepartamento]
...
BEGIN
	...
	WHERE PER.Periodo BETWEEN DATEPART(year,P.FechaInicioProyecto) AND DATEPART(year,P.FechaFinProyecto) 
	AND PET.IdDepartamento = @IdDepartamento
