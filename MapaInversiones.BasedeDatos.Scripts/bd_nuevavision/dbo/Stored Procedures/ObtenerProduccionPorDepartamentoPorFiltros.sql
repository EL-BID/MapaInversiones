...
-- =============================================
CREATE PROCEDURE [dbo].[ObtenerProduccionPorDepartamentoPorFiltros]
...
'/Produccion/FichaProduccion?periodosProduccion='+ @periodosList + '&departamento=' + Interna.IdEntidad AS Url,
...
WHERE cab.MUNICIPIO = 'N/A' --CabDptos
AND (@CuadradoVisualIntersectar.STIntersects(PuntoUbicacion)=1 OR @CuadradoVisualIntersectar IS NULL OR PuntoUbicacion IS NULL)
